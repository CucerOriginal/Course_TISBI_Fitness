...
namespace Course_TISBI_Fitness.DbContextData
{
    public class ApplicationDbContextFilialOne : DbContext
    {
        ...
        {
            optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=FitnessFilialOne;Username=postgres;Password=q1w2e3");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Client>().HasData(
                new Client { Id = 1, SecondName = "Румянцева", Name = "Евангелина ", MiddleName = "Ивановна", Address = "г.Казань, Молодежная, 15", PhoneNumber = "89534440024", Birthday = new DateOnly(1996, 03, 13), StartAbonement = new DateOnly(2022, 02, 16), EndAbonement = new DateOnly(2022, 08, 16) },
                new Client { Id = 2, SecondName = "Петров", Name = "Матвей", MiddleName = "Львович", Address = "г.Казань, Космонавтов, 54", PhoneNumber = "89573333416", Birthday = new DateOnly(1993, 06, 3), StartAbonement = new DateOnly(2022, 01, 16), EndAbonement = new DateOnly(2022, 07, 16) },
                new Client { Id = 3, SecondName = "Семенов ", Name = "Лев", MiddleName = "Маркович", Address = "г.Казань, Домодедовская, 38", PhoneNumber = "89570361116", Birthday = new DateOnly(2000, 01, 21), StartAbonement = new DateOnly(2022, 03, 16), EndAbonement = new DateOnly(2022, 09, 16) },
                new Client { Id = 4, SecondName = "Серебрякова", Name = "Майя", MiddleName = "Марковна", Address = "г.Казань, Ленина, 13", PhoneNumber = "89572067456", Birthday = new DateOnly(1994, 02, 21), StartAbonement = new DateOnly(2022, 04, 16), EndAbonement = new DateOnly(2023, 04, 16) },
                new Client { Id = 5, SecondName = "Соколова", Name = "Маргарита", MiddleName = "Ильинична", Address = "г.Казань, Космонавтов, 85", PhoneNumber = "89704337156", Birthday = new DateOnly(1994, 02, 21), StartAbonement = new DateOnly(2022, 04, 16), EndAbonement = new DateOnly(2023, 04, 16) },
                new Client { Id = 6, SecondName = "Фролов", Name = "Роман", MiddleName = "Маркович", Address = "г.Казань, Молодежная, 42", PhoneNumber = "89567094024", Birthday = new DateOnly(1996, 03, 13), StartAbonement = new DateOnly(2022, 02, 16), EndAbonement = new DateOnly(2022, 08, 16) },
                new Client { Id = 7, SecondName = "Кузнецов", Name = "Михаил", MiddleName = "Андреевич", Address = "г.Казань, Космонавтов, 35", PhoneNumber = "89713637416", Birthday = new DateOnly(1993, 06, 3), StartAbonement = new DateOnly(2022, 01, 16), EndAbonement = new DateOnly(2022, 07, 16) },
                new Client { Id = 8, SecondName = "Потапова", Name = "Варвара", MiddleName = "Михайловна", Address = "г.Казань, Чехова, 58", PhoneNumber = "89550367416", Birthday = new DateOnly(2000, 01, 21), StartAbonement = new DateOnly(2022, 03, 16), EndAbonement = new DateOnly(2022, 09, 16) },
                new Client { Id = 9, SecondName = "Павловский", Name = "Иван", MiddleName = "Львович", Address = "г.Казань, Космонавтов, 53", PhoneNumber = "89140367546", Birthday = new DateOnly(1994, 02, 21), StartAbonement = new DateOnly(2022, 04, 16), EndAbonement = new DateOnly(2023, 04, 16) },
                new Client { Id = 10, SecondName = "Ларин", Name = "Дмитрий", MiddleName = "Егорович", Address = "г.Казань, Бухарестская, 81", PhoneNumber = "89307133456", Birthday = new DateOnly(1994, 02, 21), StartAbonement = new DateOnly(2022, 04, 16), EndAbonement = new DateOnly(2023, 04, 16) });
            ...
            modelBuilder.Entity<Trainer>().HasData(
                new Trainer { Id = 1, SecondName = "Попов", Name = "Герман", MiddleName = "Евгеньевич", PhoneNumber = "89270612756", Cost = 2000 },
                new Trainer { Id = 2, SecondName = "Алешин", Name = "Максим", MiddleName = "Дмитриевич", PhoneNumber = "89574360406", Cost = 2000 },
                new Trainer { Id = 3, SecondName = "Митрофанов", Name = "Вячеслав", MiddleName = "Александрович", PhoneNumber = "89577684401", Cost = 2000 });
